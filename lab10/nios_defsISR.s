...
/* Choose which interrupt will be used for each purpose */
...
/* I/O Definitions (base addresses and port register names) go here */
/* Define the base address for the IO devices.  Use "movia ri, xxx_BASE" */
/* to load the base address into a register (e.g. register i).  Then you */
/* can use  ldwio and stwio instructions to read/write to the device. */
...
/* These offsets can be used in ldwio and stwio instructions (e.g. 
   ldwio r2, EDGE(r16) ) */
